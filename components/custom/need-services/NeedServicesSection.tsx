    ...
    <section className="need-services" ref={sectionRef}>
      <div className="need-services__inner">
        <h2 className="need-services__heading">
          Need Roofing, Siding, or Window Services
          <br />in NYC or Long Island?
        </h2>
        <p className="need-services__text">
          Request a free estimate — we inspect, document with photos, and give you a written
          quote <br />before any work begins. No pressure, no obligation.
        </p>
