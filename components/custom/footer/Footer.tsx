  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>Bellerose Roofing &amp; Siding</strong> is a family-owned roofing,
            siding, and window company serving the 5 boroughs, Nassau County, and Suffolk
            County for over 35 years. Licensed, insured, and always free estimates.
          </p>
          <div className="footer__socials">
            <a href="https://facebook.com/belleroseroofing/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social-link">
            ...
            <a href="https://instagram.com/belleroseroofing/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer__social-link">
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 Bellerose Roofing &amp; Siding. All rights reserved.</p>
