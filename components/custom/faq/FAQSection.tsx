      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Our Roofing &amp; Siding Services
          </h2>
          <p className="faq__subtext">
            Find clear answers about our roofing repairs, full replacements, siding work, window
            installation, licensing, service areas, and how we handle estimates and pricing.
          </p>
