    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Roofing, Siding &amp; Window Services for NYC &amp; Long Island
        </h2>
        <p className="services__subtext">
          From storm damage repairs to full roof replacements, siding installs, and window upgrades — Bellerose
          Roofing &amp; Siding has you covered across the 5 boroughs, Nassau, and Suffolk County.
        </p>
      </div>
