    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">What Our Customers Say</div>
          <h2 className="testimonials__heading">Trusted by NYC & Long Island Homeowners</h2>
          <p className="testimonials__subtext">
            Our clients rely on Bellerose Roofing &amp; Siding for honest pricing, quality
            workmanship, and a crew that treats their property with care — across the 5 boroughs,
            Nassau County, and Suffolk County for over 35 years.
          </p>
        </div>
