    ...
    <section className="become-section" ref={sectionRef}>
      <div className="become-section__inner">
        <p className="become-section__intro">
          Bellerose Roofing &amp; Siding is a family-owned company serving NYC and Long Island.
          If you are an experienced roofing or siding professional looking to join a reputable local team,
